 ...
 *
 * Unless required by applicable law or agreed to in ting, software
...
public class ScanningActivity extends ListActivity {
    ...
    /*    final Intent intent = new Intent(this, MainActivity.class);
        ...
        //intent.putExtra(MainActivity.EXTRAS_DEVICE_NAME, "DSC");
        //intent.putExtra(MainActivity.EXTRAS_DEVICE_ADDRESS, "B8:27:EB:F2:1E:01");
        if (mScanning) {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(MainActivity.EXTRAS_DEVICE_ADDR, device.getAddress());
